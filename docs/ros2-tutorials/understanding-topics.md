...
!!! info "Mirrored from the official ROS 2 documentation"
    ...
    Source: [https://docs.ros.org/en/humble/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Topics/Understanding-ROS2-Topics.html](https://docs.ros.org/en/humble/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Topics/Understanding-ROS2-Topics.html)  
...
The [previous tutorial](https://docs.ros.org/en/humble/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Nodes/Understanding-ROS2-Nodes.html) provides some useful background information on nodes that is built upon here.
...
Next you'll learn about another communication type in the ROS graph with the tutorial ../Understanding-ROS2-Services/Understanding-ROS2-Services.
